<!--
  ...
  Keywords: Software Engineer, Go, TypeScript, Java, Distributed Systems,
  Microservices, AI Infrastructure, Open Source, Noida, India
-->

<div align="center">

<a href="https://github.com/Rahulcse79">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=6366F1&center=true&vCenter=true&width=600&lines=Hi+%F0%9F%91%8B+I'm+Rahul+Singh;Software+Engineer+%7C+Go+%7C+TypeScript;Open+Source+Contributor;Building+AI+Infrastructure;50K%2B+daily+requests+%7C+99.9%25+uptime" alt="Rahul Singh — Software Engineer" />
</a>
...
[![Portfolio](https://komarev.com/ghpvc/?username=Rahulcse79&label=Portfolio&color=6366F1&style=for-the-badge)](https://ai-voice-portfolio.onrender.com/)
...
[![Open to Work](https://img.shields.io/badge/Open%20to-Opportunities-22C55E?style=for-the-badge&logo=googlechat&logoColor=white)](mailto:rahul.singh.cse79@gmail.com)

</div>

<p align="center">
  <em>Software Engineer with 2.5+ years building scalable, low-latency distributed systems in Go, TypeScript, and Java. Active open source contributor.</em>
</p>
...
| | |
| :---: | :---: |
| **50K+** daily API requests served | **40%** API latency reduction (Redis + PostgreSQL) |
| **99.9%** uptime across production microservices | **70%** faster CI/CD via Docker + GitLab pipelines |
| **85%+** test coverage (Jest + JUnit) | **500+** LeetCode problems solved · Top **8%** globally |
| **100+** concurrent WebSocket connections · zero leaks | **80%** customer queries auto-resolved by AI-IVR |
...
![REST](https://img.shields.io/badge/REST%20APIs-6366F1?style=for-the-badge&logo=fastapi&logoColor=white)
...
![Google STT/TTS](https://img.shields.io/badge/Google%20STT%2FTTS-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white)
![FreeSWITCH](https://img.shields.io/badge/FreeSWITCH-EE4C2C?style=for-the-badge&logo=asterisk&logoColor=white)
...
![Valgrind](https://img.shields.io/badge/Valgrind-6366F1?style=for-the-badge&logo=gnu&logoColor=white)
...
**🎙 AI-Powered Real-Time IVR Voice Agent** — FreeSWITCH C/C++ module with sub-200ms latency, GCP STT/TTS pipeline, and 100+ concurrent WebSocket sessions.
Autonomously resolves **80%+** of customer queries with zero memory leaks under sustained load.

**🛍 Dressly — Full-Stack E-Commerce** — React + Node.js/Express + MongoDB with Stripe PCI-compliant checkout and a **95+** Lighthouse score.
JWT + bcrypt auth hardened for **1K+** concurrent sessions in production.
...
<a href="https://leetcode.com/u/rahulcse79">
  <img src="https://leetcard.jacoblin.cool/rahulcse79?ext=heatmap&theme=nord" alt="Rahul Singh — LeetCode profile (Top 8% globally)" />
</a>
...
- 🔨 Contributing to [`archestra-ai/archestra`](https://github.com/archestra-ai/archestra) — an MCP-native AI platform
- 🌱 Deepening expertise in **AI agent infrastructure** & MCP tooling
- 🎯 Solving DSA problems daily on [LeetCode](https://leetcode.com/u/rahulcse79) (500+ solved · Top 8%)
- 💬 Ask me about **Go**, **distributed systems**, or **AI integration**
